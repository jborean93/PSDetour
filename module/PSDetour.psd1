...
@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/jborean93/PSDetour/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/jborean93/PSDetour'

            # A URL to an icon representing this module.
            # IconUri = ''

            # ReleaseNotes of this module
            ReleaseNotes = 'See https://github.com/jborean93/PSDetour/blob/main/CHANGELOG.md'
